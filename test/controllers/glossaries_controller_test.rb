...
class GlossariesControllerTest < ActionController::TestCase
  ...
  test "should create glossary" do
    assert_difference('Glossary.count') do
      post :create, glossary: { hitone: @glossary.hitone, hitthree: @glossary.hitthree, hittwo: @glossary.hittwo, link: @glossary.link, name: @glossary.name, x: @glossary.x, y: @glossary.y, z: @glossary.z }
    end
  ...
  test "should update glossary" do
    patch :update, id: @glossary, glossary: { hitone: @glossary.hitone, hitthree: @glossary.hitthree, hittwo: @glossary.hittwo, link: @glossary.link, name: @glossary.name, x: @glossary.x, y: @glossary.y, z: @glossary.z }
    assert_redirected_to glossary_path(assigns(:glossary))
  end
